...
# Definimos o CSS como uma constante para não repetir o código
BACKGROUND_STYLE = '''
<style>
body {
...
class BoardingSystemUI:
    ...
    def show_dashboard_page(self):
        # O ESTILO TAMBÉM FOI ADICIONADO AQUI
        ui.add_head_html(BACKGROUND_STYLE)
    ...
    # --- O restante da sua classe continua exatamente igual ---
    ...
    # --- Lógica de Dados e Comunicação com a API ---
    ...
    # --- Métodos Privados de Construção da UI ---
